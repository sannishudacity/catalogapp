...
# JSON to return all Category record
...
# JSON to return all Items for a specific category
@app.route('/category/<int:cat_id>/allItems/JSON')
def categoryAllItemsJSON(cat_id):
